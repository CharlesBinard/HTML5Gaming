...
module.exports = __webpack_require__(/*! /Users/charlesbinard/Projects/samsung/HTML5Gaming/phaser-ce/src/main.js */331);
...
var _Boot = __webpack_require__(/*! ./states/Boot */ 336);

var _Boot2 = _interopRequireDefault(_Boot);

var _Splash = __webpack_require__(/*! ./states/Splash */ 337);

var _Splash2 = _interopRequireDefault(_Splash);

var _Game = __webpack_require__(/*! ./states/Game */ 339);
...
var _utils = __webpack_require__(/*! ../utils */ 338);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function preload() {
      ...
      // load your assets
      //
      this.load.spritesheet('player', 'assets/images/player.png', 78, 128);
      this.load.tilemap('map1', 'assets/map1/map1.json', null, _phaser2.default.Tilemap.TILED_JSON);
...
var _class = function (_Phaser$Sprite) {
  ...
  _createClass(_class, [{
    ...
    key: 'initMouvement',
    value: function initMouvement() {
      this.upButton = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.UP);
      this.leftButton = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.LEFT);
      this.downButton = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.DOWN);
      this.rightButton = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.RIGHT);
      this.game.input.keyboard.addKeyCapture([_phaser2.default.Keyboard.UP, _phaser2.default.Keyboard.LEFT, _phaser2.default.Keyboard.DOWN, _phaser2.default.Keyboard.RIGHT]);
    }
  }, {
    key: 'initAnimation',
